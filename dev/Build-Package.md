...
```
    ...
    ## • NOT_CRAN                      : true
    ## ── R CMD check ─────────────────────────────────────────────────────────────────
    ##       ─  using log directory 'C:/Users/daniel.carpenter/AppData/Local/Temp/Rtmp61lRdf/styles.cmac.Rcheck' (444ms)
    ## ─  using R version 4.2.3 (2023-03-15 ucrt)
    ## ─  using platform: x86_64-w64-mingw32 (64-bit)
    ## ─  using session charset: UTF-8
    ##       ─  using options '--no-manual --as-cran' (576ms)
    ##   ✔  checking for file 'styles.cmac/DESCRIPTION'
    ## ─  checking extension type ... Package
    ## ─  this is package 'styles.cmac' version '0.1.0'
    ## ─  package encoding: UTF-8
    ## ✔  checking package namespace information
    ##    checking package dependencies ...     checking package dependencies ...   ✔  checking package dependencies (7.6s)
    ...
    ##    checking whether package 'styles.cmac' can be installed ...     checking whether package 'styles.cmac' can be installed ... [14s]     checking whether package 'styles.cmac' can be installed ... [14s]   ─  checking whether package 'styles.cmac' can be installed ... [14s] OK (13.5s)
    ##    checking installed package size ...     checking installed package size ...   ✔  checking installed package size (1000ms)
    ##       ✔  checking package directory (568ms)
    ##      checking for future file timestamps ...     checking for future file timestamps ...   ✔  checking for future file timestamps
    ...
    ##    checking index information ...     checking index information ...   ✔  checking index information (344ms)
    ##    checking package subdirectories ...     checking package subdirectories ...   ✔  checking package subdirectories (369ms)
    ...
    ##      alpha
    ##    checking Rd files ...     checking Rd files ...   ✔  checking Rd files (441ms)
    ...
    ##    
    ##    See
    ##      'C:/Users/daniel.carpenter/AppData/Local/Temp/Rtmp61lRdf/styles.cmac.Rcheck/00check.log'
    ##    for details.
    ##    
    ##    
    ## 
...
```
    ...
    ##          checking for file 'C:\Users\daniel.carpenter\Documents\GitHub\FPA-GitHub\CN-CMAC\styles.cmac/DESCRIPTION' ...     checking for file 'C:\Users\daniel.carpenter\Documents\GitHub\FPA-GitHub\CN-CMAC\styles.cmac/DESCRIPTION' ...   ✔  checking for file 'C:\Users\daniel.carpenter\Documents\GitHub\FPA-GitHub\CN-CMAC\styles.cmac/DESCRIPTION' (403ms)
    ##       ─  preparing 'styles.cmac': (6.3s)
    ##    checking DESCRIPTION meta-information ...  ✔  checking DESCRIPTION meta-information
    ##       ─  installing the package to build vignettes
    ##          creating vignettes ...     creating vignettes ...   ✔  creating vignettes (29.3s)
    ##       ─  checking for LF line-endings in source and make files and shell scripts (3.5s)
    ##   ─  checking for empty or unneeded directories
    ##      Omitted 'LazyData' from DESCRIPTION
    ##       ─  building 'styles.cmac_0.1.0.tar.gz'
...
```
    ...
    ##   "C:\Users\DANIEL~1.CAR\AppData\Local\Temp\Rtmp61lRdf/styles.cmac_0.1.0.tar.gz" \
    ##   --install-tests 
